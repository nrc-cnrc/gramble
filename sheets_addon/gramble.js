 ...
 * successor UnionStates, their successors are just the successors of their children.
 */
class MorePerfectUnion extends State {
...
exports.MorePerfectUnion = MorePerfectUnion;
/**
...
function Uni(...children) {
    ...
    return new MorePerfectUnion(children);
    /*
    if (children.length == 1) {
        return children[0];
    }
