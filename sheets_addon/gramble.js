...
},{"./sheetParser":43,"./stateMachine":44}],43:[function(require,module,exports){
"use strict";
/**
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.createProject = exports.Project = exports.EnclosureComponent = exports.GrammarComponent = exports.CellComponent = exports.constructHeader = exports.SlashHeader = exports.EndsWithHeader = exports.StartsWithHeader = exports.EqualsHeader = exports.JoinHeader = exports.RenameHeader = exports.NotHeader = exports.MaybeHeader = exports.CommentHeader = exports.LiteralHeader = exports.DropHeader = exports.EmbedHeader = exports.Header = void 0;
...
class AtomicHeader extends Header {
    ...
    static *parseAux(target, constructor, input) {
...
class UnaryHeader extends Header {
    ...
    static *parseAux(target, constructor, childParser, input) {
        if (input.length == 0 || input[0] != target) {
            return;
        }
 ...
 */
class BooleanHeader extends UnaryHeader {
    merge(leftNeighbor, state) {
        if (leftNeighbor == undefined) {
            return state;
        }
    ...
    compilePiece(parsedText, cell, namespace, devEnv) {
        ...
        if (parsedText instanceof cellParser_1.MPNegation) {
            const childCell = this.compilePiece(parsedText.child, cell, namespace, devEnv);
            const compiledCell = new UnaryHeadedCellComponent(this, cell, childCell);
            compiledCell.state = stateMachine_1.Not(childCell.state);
            return compiledCell;
        }
        if (parsedText instanceof cellParser_1.MPAlternation) {
 ...
 */
class JoinHeader extends BooleanHeader {
    static *parse(input) {
...
class StartsWithHeader extends EqualsHeader {
    compileLiteral(parsedText, cell, namespace, devEnv) {
        ...
        for (const tape of relevantTapes) {
            const anychars = stateMachine_1.Rep(stateMachine_1.Any(tape));
            result.state = stateMachine_1.Seq(result.state, anychars);
        }
        return result;
    }
    static *parse(input) {
...
class EndsWithHeader extends EqualsHeader {
    compileLiteral(parsedText, cell, namespace, devEnv) {
        ...
        for (const tape of relevantTapes) {
            const anychars = stateMachine_1.Rep(stateMachine_1.Any(tape));
            result.state = stateMachine_1.Seq(anychars, result.state);
        }
        return result;
    }
    static *parse(input) {
 ...
 */
function constructHeader(headerText, pos = util_1.DUMMY_POSITION) {
...
class Project {
    ...
    getTapeNames(symbolName) {
        ...
        for (const tapeName of startState.getRelevantTapes(stack)) {
            const header = constructHeader(tapeName, new util_1.CellPosition("?", -1, -1));
        ...
        for (var rowIndex = 0; rowIndex < cells.length; rowIndex++) {
            ...
            for (var colIndex = 0; colIndex < row.length; colIndex++) {
                ...
                try {
                    ...
                    cell.markError(this.devEnv, `Invalid header: ${cell.text}`, `Attempted to parse "${cell.text}" as a header, but could not.`);
                }
            }
        }
...
class CompiledState extends State {
    constructor(originalState, allTapes, symbolStack, compileLevel) {
        ...
        for (const tape of tapes) {
            for (const [resTape, resToken, resMatched, resNext] of originalState.dQuery(tape, tape.any(), symbolStack)) {
...
class BinaryState extends State {
    ...
    setRandom(randomize, symbolStack) {
        ...
        this.child2.setRandom(randomize, symbolStack);
    }
    getRelevantTapes(stateStack) {
        if (this.relevantTapes == undefined) {
 ...
 */
class OldUnionState extends BinaryState {
    constructor() {
        super(...arguments);
...
exports.OldUnionState = OldUnionState;
...
class SemijoinState extends BinaryState {
    ...
    *ndQuery(tape, target, symbolStack) {
        yield* this.ndQueryLeft(tape, target, this.child1, this.child2, symbolStack);
    }
}
/**
...
class UnaryState extends State {
    setRandom(randomize, symbolStack) {
        this.child.setRandom(randomize, symbolStack);
    }
    get id() {
...
class RepetitionState extends UnaryState {
    ...
    setRandom(randomize, symbolStack) {
        this.child.setRandom(randomize, symbolStack);
        this.initialChild.setRandom(randomize, symbolStack);
    }
    getRelevantTapes(stateStack) {
        if (this.relevantTapes == undefined) {
    ...
    *ndQuery(tape, target, symbolStack) {
        ...
        if (this.child.accepting(symbolStack)) {
            ...
            const successor = new RepetitionState(this.initialChild, this.minReps, this.maxReps, this.index + 1, this.initialChild);
        ...
        for (const [childTape, childText, childMatched, childNext] of this.child.dQuery(tape, target, symbolStack)) {
            ...
            yield [childTape, childText, childMatched, new RepetitionState(childNext, this.minReps, this.maxReps, this.index, this.initialChild)];
        }
    }
}
...
class EmbedState extends State {
    ...
    *ndQuery(tape, target, symbolStack) {
        ...
        for (const [childchildTape, childTarget, childMatched, childNext] of child.dQuery(tape, target, symbolStack)) {
...
},{"./tapes":45}],45:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"bitset":39}],46:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
