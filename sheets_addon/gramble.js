...
class EqualsHeader extends JoinHeader {
    merge(leftNeighbor, state) {
        ...
        if (leftNeighbor instanceof stateMachine_1.BrzConcat) {
            ...
            return stateMachine_1.Seq(leftNeighbor.child1, stateMachine_1.Filter(leftNeighbor.child2, state));
        }
...
class GrammarComponent extends util_1.TabularComponent {
    constructor() {
        super(...arguments);
        this.state = stateMachine_1.Epsilon();
        /**
...
class ContentsComponent extends EnclosureComponent {
    ...
    compile(namespace, devEnv) {
        ...
        rowStates = rowStates.filter(state => !(state instanceof stateMachine_1.BrzEpsilon));
    ...
    compile(namespace, devEnv) {
        ...
        for (const [header, cell] of this.uncompiledCells) {
            ...
            try {
                ...
                if (cell.text.length > 0 && !(compiledCell.state instanceof stateMachine_1.BrzEpsilon)) {
        ...
        if (resultState == undefined) {
            ...
            resultState = stateMachine_1.Epsilon();
        }
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.setChain = exports.setDifference = exports.setIntersection = exports.bigUnion = exports.setUnion = exports.RGBtoString = exports.HSVtoRGB = exports.iterTake = exports.shuffleArray = exports.meanAngleDeg = exports.DUMMY_POSITION = exports.TabularComponent = exports.CellPosition = void 0;
/**
