...
class Project {
    ...
    compile(symbolName, compileLevel) {
...
},{"./devEnv":2,"./stateMachine":5,"./util":7}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Namespace {
    ...
    compileLocalSymbol(name, allTapes, symbolStack, compileLevel) {
        ...
        const compiledState = state.compile(allTapes, symbolStack, compileLevel);
...
class State {
    ...
    *generate(randomize = false, maxRecursion = 4, maxChars = 1000) {
    ...
    compile(allTapes, symbolStack, compileLevel) {
        return this;
    }
}
exports.State = State;
    ...
    constructor(originalState, allTapes, symbolStack, compileLevel) {
        ...
        for (const tape of tapes) {
            for (const [resTape, resToken, resMatched, resNext] of originalState.dQuery(tape, tape.any(), symbolStack)) {
                const compiledNext = resNext.compile(allTapes, symbolStack, compileLevel - 1);
...
class ConcatState extends BinaryState {
    ...
    compile(allTapes, symbolStack, compileLevel) {
        ...
        const newChild1 = this.child1.compile(allTapes, symbolStack, compileLevel);
        const newChild2 = this.child2.compile(allTapes, symbolStack, compileLevel);
...
class UnionState extends State {
    ...
    compile(allTapes, symbolStack, compileLevel) {
        ...
        const newChildren = this.children.map(c => c.compile(allTapes, symbolStack, compileLevel));
...
class RepetitionState extends UnaryState {
    ...
    compile(allTapes, symbolStack, compileLevel) {
        ...
        const newInitialChild = this.initialChild.compile(allTapes, symbolStack, compileLevel);
...
class ProjectionState extends UnaryState {
    ...
    compile(allTapes, symbolStack, compileLevel) {
        ...
        const newChild = this.child.compile(allTapes, symbolStack, compileLevel);
...
class NegationState extends State {
    ...
    compile(allTapes, symbolStack, compileLevel) {
        ...
        if (newChild != undefined) {
            newChild = newChild.compile(allTapes, symbolStack, compileLevel);
        }
