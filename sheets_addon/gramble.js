...
},{"./sheetParser":42,"./stateMachine":43}],42:[function(require,module,exports){
"use strict";
/**
...
class FlagHeader extends UnaryHeader {
    ...
    compile(cell, namespace, devEnv) {
        ...
        compiledCell.state = stateMachine_1.Uni(...childCells.map(c => c.state));
        return compiledCell;
    }
}
...
class TableComponent extends EnclosureComponent {
    compile(namespace, devEnv) {
        ...
        if (this.sibling != undefined) {
            ...
            this.markWarning(devEnv, "Table overwrite warning", "'table' here will obliterate the preceding " +
                `content above this.`);
        }
        this.child.compile(namespace, devEnv);
        this.state = this.child.state;
...
class ContentsComponent extends EnclosureComponent {
    ...
    runChecks(ns, devEnv) {
        if (this.sibling != undefined) {
            this.markWarning(devEnv, "Table overwrite warning", "Content here will obliterate the preceding " +
                `content above this.`);
        }
...
},{"./devEnv":40,"./stateMachine":43,"./util":45,"chai":2}],43:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./tapes":44}],44:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"bitset":39}],45:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
