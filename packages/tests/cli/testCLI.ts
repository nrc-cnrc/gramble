...
describe(`${cliTestSuiteName(module)}`, function() {
    ...
    testCLI({
        ...
        command: `gramble generate ${GRAMBLE_HOME}/examples/helloworld.csv`,
        results: [
            'text',
            '"goodbyekitty"',
            '"goodbyeworld"',
    ...
    testCLI({
        ...
        command: `gramble generate ${GRAMBLE_HOME}/examples/none.csv`,
        results: [],
        errors: [
    ...
    testCLI({
        ...
        command: `gramble generate ${GRAMBLE_HOME}/examples/helloworld.csv -m 3`,
        results: [
            'text',
            '"goodbyekitty"',
            '"goodbyeworld"',
    ...
    testCLI({
        ...
        command: `gramble generate ${GRAMBLE_HOME}/examples/helloworld.csv -m 10`,
        results: [
            'text',
            '"goodbyekitty"',
            '"goodbyeworld"',
    ...
    testCLI({
        ...
        command: `gramble generate ${GRAMBLE_HOME}/examples/helloworld.csv -m 0`,
        results: [
            'text',
        ],
    });
    ...
    testCLI({
        ...
        command: `gramble generate ${GRAMBLE_HOME}/examples/helloworld.csv -m`,
        results: [
            'text',
            '"goodbyekitty"',
            '"goodbyeworld"',
    ...
    testCLI({
        ...
        command: `gramble generate ${GRAMBLE_HOME}/examples/helloworld.csv -m zero`,
        results: [
            'text',
            '"goodbyekitty"',
            '"goodbyeworld"',
    ...
    testCLI({
        ...
        command: `gramble generate ${GRAMBLE_HOME}/examples/helloworld.csv -s all`,
        results: [
            'text',
            '"goodbyekitty"',
            '"goodbyeworld"',
    ...
    testCLI({
        ...
        command: `gramble generate ${GRAMBLE_HOME}/examples/helloworld.csv -s`,
        results: [
            'text',
            '"goodbyekitty"',
            '"goodbyeworld"',
    ...
    testCLI({
        ...
        command: `gramble generate ${GRAMBLE_HOME}/examples/helloworld.csv -s XXX`,
        results: [],
        errors: [
    ...
    testCLI({
        ...
        command: `gramble generate ${GRAMBLE_HOME}/examples/helloworld.csv -q`,
        results: [
            'text',
            '"goodbyekitty"',
            '"goodbyeworld"',
    ...
    testCLI({
        ...
        command: `gramble generate ${GRAMBLE_HOME}/examples/helloworld.csv --format csv`,
        results: [
            'text',
            '"goodbyekitty"',
            '"goodbyeworld"',
    ...
    testCLI({
        ...
        command: `gramble generate ${GRAMBLE_HOME}/examples/helloworld.csv --format json`,
        results: [
            '[',
            '  {"text":"goodbyekitty"},',
            '  {"text":"goodbyeworld"},',
