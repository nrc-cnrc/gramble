...
describe(`${grammarTestSuiteName(module)}`, function() {
    ...
    testGrammar({
        ...
        grammar: Seq(t1("hi"), Rep(Dot("t1"), 0, 3)),
        results: [
            {t1: 'hi'},
            {t1: 'hii'},   {t1: 'hih'},
            {t1: 'hihh'},  {t1: 'hihi'},
    ...
    testGrammar({
        ...
        grammar: Seq(Rep(Dot("t1"), 0, 3), t1("hi")),
        results: [
            {t1: 'hi'},
            {t1: 'hhi'},   {t1: 'ihi'},
            {t1: 'hhhi'},  {t1: 'hihi'},
    ...
    testGrammar({
        ...
        grammar: Seq(Count({t1: 1}, Rep(Dot("t1"))),
                     t1("hi"),
                     Count({t1: 1}, Rep(Dot("t1")))),
        results: [
            {t1: 'hi'},
            {t1: 'hih'},  {t1: 'hii'},
            {t1: 'hhi'},  {t1: 'ihi'},
    ...
    testGrammar({
        ...
        grammar: Count({t1: 4},
                 	   Seq(Rep(Dot("t1")), t1("hi"), Rep(Dot("t1")))),
        results: [
            {t1: 'hi'},
            {t1: 'hih'},  {t1: 'hii'},
            {t1: 'hhi'},  {t1: 'ihi'},
    ...
    testGrammar({
        ...
        grammar: Join(t1("h"), Rep(Dot("t1"), 0, 1)),
        results: [
            {t1: 'h'},
        ],
    });
    ...
    testGrammar({
        ...
        grammar: Join(Rep(Dot("t1"), 0, 2), Epsilon()),
        results: [
            {}
        ],
    });
    ...
    testGrammar({
        desc: '50*. Join t1:.* ⨝ ε',
        grammar: Join(Rep(Dot("t1")), Epsilon()),
        results: [
            {}
        ],
    });
    ...
    testGrammar({
        ...
        grammar: Join(Epsilon(), Rep(Dot("t1"), 0, 2)),
        results: [
            {}
        ],
    });
    ...
    testGrammar({
        desc: '51*. Join ε ⨝ t1:.*',
        grammar: Join(Epsilon(), Rep(Dot("t1"))),
        results: [
            {}
        ],
    });
