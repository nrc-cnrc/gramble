import {
    Embed, Collection, Seq, Uni, Join, Epsilon, Null,
} from "../src/grammars";
...
describe(`${testSuiteName(module)}`, function() {
    ...
    describe('2. Symbol containing ε', function() {
        const grammar = Collection({a: Epsilon(), b: Embed("a")});
        //testHasVocab(grammar, {t1: 2});
        testGrammar(grammar, [{}], SILENT, "b");
    });

    describe('3. Symbol containing ε, other order', function() {
        const grammar = Collection({b: Embed("a"), a: Epsilon()});
        //testHasVocab(grammar, {t1: 2});
        testGrammar(grammar, [{}], SILENT, "b");
    });

    describe('4. Symbol containing ε+ε', function() {
    ...
    describe('5. Symbol containing ∅', function() {
        const grammar = Collection({a: Null(), b: Embed("a")});
        //testHasVocab(grammar, {t1: 2});
        testGrammar(grammar, [], SILENT, "b");
    });
    ...
    describe('8. Symbol containing t1:hi + t1:world', function() {
        const grammar = Collection({
    ...
    describe('10. Symbol containing t1:hi + t2:world', function() {
        const grammar = Collection({
    ...
    describe('11. Symbol containing t1:hi | t1:goodbye', function() {
        const grammar = Collection({
    ...
    describe('12. Symbol of (t1:hi ⋈ t1:hi+t2:bye)', function() {
        const grammar = Collection({
    ...
    describe('13. Join sym(t1:hi ⋈ t1:hi+t2:bye) ⋈ t2:bye+t3:yo', function() {
        const grammar = Collection({
            hi2bye: Join(t1("hi"), Seq(t1("hi"), t2("bye"))),
    ...
    describe('14. Join t1:hi ⋈ sym(t1:hi+t2:bye ⋈ t2:bye+t3:yo)', function() {
        const grammar = Collection({
    ...
    describe('15. sym(t1:hi ⋈ t1:hi+t2:bye) + t2:world', function() {
        const grammar = Collection({
            hi2bye: Join(t1("hi"), Seq(t1("hi"), t2("bye"))),
    ...
    describe('19. Nested collections with identical names, ' +
             'and a symbol in the inner referring to a symbol ' +
    ...
    describe('20. Nested collections with identical names, ' +
             'and a symbol in the outer referring to a symbol ' +
             'in the inner', function() {
        const inner = Collection({
            x: t1("hello")
        });
    ...
    describe('21. Nested collections where an embed in outer ' +
             'refers to inner', function() {
        const inner = Collection({
            x: t1("hello")
        });
        const outer = Collection({
    ...
    describe('22. Nested collections with two inners, ' +
             'and embed in second refers to symbol in first', function() {
    ...
    describe('23. Nested collections with two inners, and ' +
