...
describe(`${testSuiteName(module)}`, function() {
    ...
    testRegexID("2d", "~", "ε", 1);    
    testRegexID("2e", '1SG~', "ε", 1);
    testRegexID("2f", "~(1SG)", "NOT[1SG]");
    ...
    testRegexID("3o", "(1)(SG)", "[1,SG]");
    testRegexID("3p", "(1|2)SG", "[OR[1,2],SG]");
    testRegexID("3q", "1|2SG", "OR[1,2SG]");
    testRegexID("3r", "1~2SG", "[1,NOT[2SG]]");
    testRegexID("3s", "1SG*", "STAR[1SG]");   
    testRegexID("3t", "1SG*1SG", "[STAR[1SG],1SG]");
    testRegexID("3u", "1SG\\*", "1SG*");   
    testRegexID("3v", "1S(G)*", "[1S,STAR[G]]");   
    testRegexID("3w", "~1SG*", "NOT[STAR[1SG]]");
    testRegexID("3x", "(~1SG)*", "STAR[NOT[1SG]]");
    testRegexID("3y", "1SG|2SG*", "OR[1SG,STAR[2SG]]");
    ...
    testRegexID("3jj", "((1SG)(2SG))+", "PLUS[[1SG,2SG]]");
    ...
    testRegexID("3ss", "1SG 2SG|3SG", "[1SG,OR[2SG,3SG]]");
    testRegexID("3tt", "1SG|2SG 3SG", "[OR[1SG,2SG],3SG]");
