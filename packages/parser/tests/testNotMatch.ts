...
describe(`${path.basename(module.filename)}`, function() {
    ...
    describe('1a. MatchFrom(t1>t2, t1:hi)', function() {
        ...
        testGrammar(grammar, expectedResults, DUMMY_SYMBOL_NAME, DEFAULT_MAX_RECURSION, 5);
    });

    describe('1b. Negation of 1a results: ~(t1:hi+t2:hi)', function() {
    ...
    describe('1b-1. Negation of 1a results: ~(t1:hi+t2:hi, 4)', function() {
    ...
    describe('1b-2. Negation of 1a results: ~(t1:hi+t2:hi, 3)', function() {
    ...
    describe('1b-3. Negation of 1a results: ~(t1:hi+t2:hi, 2)', function() {
    ...
    describe('1b-4. Negation of 1a results: ~(t1:hi+t2:hi, 1)', function() {
