...
describe(`${testSuiteName(module)}`, function() {
    ...
    testHeaderID("27.", "pre text", "pre[text]");
    testHeaderID("28.", "post text", "post[text]");
    testHeaderID("29.", "from text", "from[text]");
    testHeaderID("30.", "to text", "to[text]");
    testHeaderID("31.", "pre", "pre[.i]");
    testHeaderID("32.", "post", "post[.i]");
    testHeaderID("33.", "from", "from[.i]");
    testHeaderID("34.", "to", "to[.o]");
    testHeaderID("35.", "pre(text)", "pre[text]");
    testHeaderID("36.", "(pre text)", "pre[text]");
