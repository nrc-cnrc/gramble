...
import { testCellID, testPlaintextID } from "./testUtil";

describe(`${path.basename(module.filename)}`, function() {

    describe("Testing plaintext content", function() {
        testPlaintextID("", "");
        testPlaintextID(" ", "");
        testPlaintextID("()", "[()]");
        testPlaintextID("( )", "[(,)]");
    ...
    describe("Testing regexes", function() {
        ...
        testCellID("1SG 2SG|3SG", "[1SG,OR[2SG,3SG]]");
        testCellID("1SG|2SG 3SG", "[OR[1SG,2SG],3SG]");
    }); 
});