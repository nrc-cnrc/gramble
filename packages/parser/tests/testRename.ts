...
import { t1, t2, t3, testHasTapes, testHasVocab, testHasNoVocab, testGrammar, unrelated, t4 } from "./testUtils";
...
describe(`${path.basename(module.filename)}`, function() {
    ...
    describe('rename(t1:hello+unrelated:foo) from t1 to t2', function() {
        ...
        testHasNoVocab(grammar, "t1");
        testGrammar(grammar, [{t2: "hello", unrelated: "foo"}]);
    });
    ...
    describe('Alt(rename(t1:hello+unrelated:foo) t1 -> t2|rename(t1:hello+unrelated:foo) t1->t3)', function() {
        ...
        testHasNoVocab(grammar, "t1");
        testGrammar(grammar, [{t2: "hello", unrelated: "foo"}, {t3: "hello", unrelated: "foo"}]);
    });
    ...
    describe('Rename + embed bug encountered in implementing templates', function() {
        ...
        testGrammar(grammar, [{"t1":"hi","t3":"hello","t4":"goodbye","unrelated":"foo"}, 
